kw = ['AVENGERS', 'avengers', 'Endgame spoiler', 'endgame', 'Avengers Engame Spoiler', 'Avengers Endgame', 'AVENGERS ENDGAME', 'death', 'DEAD', 'Dead', 'Died', 'DEATH', 'Death', 'DIED', 'Iron Man', 'Captain America', 'Captain Marvel', 'Thor', 'Stormbreaker', 'Marvel', 'Russo', 'Russo Brothers', 'Hulk', 'Professor Hulk', 'Tony Stark', 'ant man', 'Ant Man', 'Ant man','loki','Loki','Star Lord','Star-Lord']
tags = "SPANEMBIULOLI";
total = 0;
...
function hideNode(node) {
	node.textContent = '[TEXT BLOCKED:END GAME SPOILER DETECTED]';
